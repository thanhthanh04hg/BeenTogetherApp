...
extension AnimatorFire {
    ...
    public func addShadowToView(targetContainerView: UIView) {
        self.menuTools.addShadowToView(targetContainerView: targetContainerView)
    }
    ...
    public func animateLeftSideToOpen() {
        ...
        self.animationType.openLeftWithVelocity(velocity: SliderMenuOptions.leftViewWidth)
    }

    public func animateLeftSideToClose() {
        self.animationType.closeLeftWithVelocity(velocity: 0.0)
    }
    ...
    public func animateRightSideToOpen() {
        ...
        self.animationType.openRightWithVelocity(velocity: -SliderMenuOptions.rightViewWidth)
    }

    public func animateRightSideToClose() {
        self.animationType.closeRightWithVelocity(velocity: 0.0)
    }
}
